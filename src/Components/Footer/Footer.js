...
import "./Footer.css";
import FooterLogo from "../../images/website_logo.png";
      ...
      <div className="row mx-5 py-5">
        <div className="col-lg-4 m-2">
          <div className="d-flex align-items-center mb-3">
            <img src={FooterLogo} alt="brand name" className="img-fluid logo-size" />
          </div>
          <p>
            TravelGo is a cutting-edge React tourism project template. The
        ...
        <div className="col m-2">
          ...
          <h6>
            <i className="fas fa-paper-plane"></i> travelGo-torism@gmail.com
          </h6>
        </div>
